...
>>>>>>> refs/remotes/origin/DutchExchange-2.0_Alex
            }
        }
    }
...
>>>>>>> refs/remotes/origin/DutchExchange-2.0_Alex
        ...
        returns (uint fee)
    {
        ...
        if (fee > 0) {
            ...
            //burning OWL tokens with delegatecall is risky,
            // because this allows OWL token to modify the storage of this contract.
