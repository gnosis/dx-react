...
<article>
  ...
  <section className="drawer active">
    ...
    Using this interface, you will participate in the next running auction.</p>
  </section>
  <section className="drawer">
    ...
    However, it comes with the drawback of slow execution!</p>
  </section>
  <section className="drawer">
  ...
  <section className="drawer">
    ...
    At the moment, there is no notification, which means that you have to revisit this interface. A red claim button will alert that you are able to claim your receive Token.</p>
  </section>
  <section className="drawer">
  ...
  <section className="drawer">
    ...
    <p>Once you have submitted your order and the next auction has started (you can see that an auction has started in the specific auction URL provided for you after you submitted your order) and finished, you may proceed to claim the tokens you receive. At the moment, there is no notification, which means that you have to revisit this interface. A red claim button will alert that you are able to claim your receive token.
      ...
      <ul>
        ...
        <li>The second option is provided to you via the specific URL for the auction pairing. You will see this screen at the end of the order process and you there you may claim the token particularly for that specific auction. You will only need to sign once.</li></ul>
        <strong>Note that you have to be connected to the same wallet that you participated with in order to claim!</strong>
      </p>
    </section>
    <section className="drawer">
      <h3>What is displayed in “Your Auctions”?</h3>
      <p>You can see three statuses:
        <ul>
        ...
        If you have none of the three mentioned, you will see a message “No Auctions to show”.
...
{/* END API and Technical Links - page */}
...
{/* END Downtime and Maintenance - page */}
