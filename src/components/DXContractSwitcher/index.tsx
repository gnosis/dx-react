...
export default class DXContractPicker extends React.Component<{}, DXContractPickerState> {
  ...
  async componentDidMount() {
      ...
      return this.setState({
          ALL_OLD_CONTRACT_ADDRESSES,
          CONTRACT_ADDRESSES_TO_USE,
          DX_ADDRESS_TO_USE: CONTRACT_ADDRESSES_TO_USE['DutchExchange'][network].address,
          VERSION_TO_USE: CONTRACT_ADDRESSES_TO_USE['DutchExchange'].version,
          network,
        })
    }
  ...
  changeDXAddress = async (e: ChangeEvent<HTMLSelectElement>) => {
      ...
      this.setState({
          ...
          DX_ADDRESS_TO_USE: OLD_CONTRACT_OBJECT_TO_USE['DutchExchange'][network].address,
        })
