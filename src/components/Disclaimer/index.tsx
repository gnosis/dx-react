  ...
  <div>
    ...
    <form>
      ...
      <label htmlFor="disclaimer1">
        I am <strong>NOT</strong> a citizen or resident of and I am <strong>NOT</strong> currently in the People's Republic of China or an entity formed under the laws of the People's Republic of China.
      </label>
      </div>
      ...
      <label htmlFor="disclaimer2">
        I certify that I am NOT (and NOT under the control of), a citizen or resident of or entity formed under the laws of any of the following countries and/or territories and that I am NOT currently in any thereof: Afghanistan, Belarus, Bosnia and Herzegovina, Cote d’Ivoire, Central African Republic, Crimea (Region of Ukraine), Cuba, Democratic Republic of the Congo, Democratic People's Republic of Korea, Eritrea, Ethiopia, Guinea-Bissau, Iran, Iraq, Japan, Myanmar, Libya, Lebanon, Liberia, Russian Federation, Somalia, South Sudan, Sudan, Syria, Uganda, United States of America, Vanuatu, Venezuela, Yemen, Zimbabwe.
      </label>
      </div>
      ...
      <label htmlFor="disclaimer3">
        I certify that (1) I am NOT a person on the U.S. Treasury Department's Specially Designated Nationals List or the U.S. Commerce Department's Denied Persons List, Unverified List, Entity List, or the EU consolidated list of persons, groups or entities subject to EU financial sanctions (a "Sanctioned Person"); and (2) I do not act on behalf a Sanctioned Country (or a national or resident of a Sanctioned Country) or Sanctioned Person.
      </label>
      </div>
...
- The process is governed by a smart contract; there is no intermediary between seller and bidders. Trades happen directly peer-to-peer.<br/>
- Blockchain transactions are (likely) irreversible. The wallet address and your transaction will be displayed permanently and publicly, this inherent to services available on blockchain. The right to request rectification or erasure of personal data is not possible with blockchain technology.<br/>
...
- ERC-20 tokens are not a currency in legal terms and are not backed by assets. The value may be highly volatile. This volatility might cause unforeseen price fluctuations as auctions typically run for some time and trades are not executed instantly.<br/>
- There is neither a price guarantee nor a liquidity guarantee on the DutchX. <br/>
- The availability of a token does not indicate approval or disapproval, volume or any other measure of quality. Tokens may be added by anyone using the governing mechanisms of the smart contract which is open source and available to all; Token lists may be created by anyone and there is no approval or blacklisting process.<br/>
- You are prohibited from using or accessing DutchX to transmit or exchange digital assets that are the direct or indirect proceeds of any criminal or fraudulent activity, including terrorism or tax evasion.<br/>
- In no event shall the initiator, programmer, auditor, auctioneer, participant or any other person or entity which was/is involved in the creation of, maintenance of or any other form of interaction or support of the DutchX be liable for any indirect, special, incidental, consequential, or exemplary damages of any kind arising out of or in any way related to the use of the DutchX, regardless of the form of action, whether based in contract, tort or any other legal or equitable theory. <br/>
