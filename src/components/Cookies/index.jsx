      ...
      return (
        ...
        <div className="contentPage">
          <article id="cookiesArticle">
            ...
            >{settingsOpen ? 'Close' : 'Open'} Cookie Preferences
            </button>
            ...
            <span>
              ...
              A cookie can be classified by its lifespan and the domain to which it belongs.<br /><br />
              ...
              <p><strong>What cookies do we use and why?</strong><br />
              We list all the cookies we use on this website in the <ScrollToLink to="./cookies#appendix" hash="#appendix">APPENDIX</ScrollToLink> below.
              ...
              <p>
                <strong>What data are collected by cookies and other technologies on our website?</strong><br />
              ...
              <p>
                <strong>Google Analytics Cookies</strong><br />
              ...
              <p><br />As stated above, cookie-related information is not used to identify you personally, and what is compiled is only aggregate data that tells us, for example, what countries we are most popular in, but not that you live in a particular country or your precise location when you visited our website (this is because we have only half the information- we know the country the person is browsing from, but not the name of person who is browsing). In such an example Google will analyze the number of users for us, but the relevant cookies do not reveal their identities.</p>
              <p>By using this website, you consent to the processing of data about you by Google in the manner and for the purposes set out above. Google Analytics, its purpose and function is further explained on the Google Analytics website.
                <br /><br />
